...
export const metadata: Metadata = {
  title: "Contact Us",
  description: "Get in touch with the TariffPeek team.",
};
...
export default function ContactPage() {
  return (
    <article className="prose prose-slate max-w-3xl mx-auto">
      ...
      <p>
        We would love to hear from you. Whether you have a question about HS codes, a suggestion for improvement, or
      ...
      <div className="bg-slate-50 border border-slate-200 rounded-lg p-6 mt-6">
        ...
        <p className="mb-2">
          <strong>Email:</strong>{" "}
          <a href="mailto:contact@tariffpeek.com" className="text-indigo-600 hover:underline">
            contact@tariffpeek.com
          </a>
        </p>
      ...
      <p>
        Your feedback helps us improve TariffPeek for everyone. If you notice any data discrepancies or have ideas
        for new features, please let us know.
      </p>

      <h2 className="text-xl font-semibold mt-8 mb-3">Data Corrections</h2>
      <p>
        Our HS code data is sourced from the World Customs Organization and UN Comtrade. If you believe there is an
        error in the data displayed on our site, please email us with the specific page URL and a description of the
        issue.
      </p>

      <h2 className="text-xl font-semibold mt-8 mb-3">DataPeek Facts Network</h2>
      <p>
        TariffPeek is part of the{" "}
