...
// HCU 2026-04-24: CWV showed CLS 0.701 (Poor) on /code/* pages traced to this
// component. The fix: reserve vertical space during SSR / pre-mount so the
// page doesn't reflow when entries populate. `mounted` flips after the first
// client render; until then we render an invisible block of the expected
// height. If the scan finds <3 h2s we also keep the reserved space instead of
// collapsing — keeps above-and-below content stable either way.
